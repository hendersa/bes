...
// AWH - This was 11, rather than 9, for Tommee
    ...
    keymaps.push_back(strpair_t("J01:B9",        "Joypad2 Start"));
		...
		keymaps.push_back(strpair_t("K00:SDLK_BACKSPACE",    "Joypad1 Select"));
		keymaps.push_back(strpair_t("K00:SDLK_z",            "Joypad1 A"));
		keymaps.push_back(strpair_t("K00:SDLK_x",            "Joypad1 B"));
		keymaps.push_back(strpair_t("K00:SDLK_d",            "Joypad1 X"));
		keymaps.push_back(strpair_t("K00:SDLK_c",            "Joypad1 Y"));
		keymaps.push_back(strpair_t("K00:SDLK_a",            "Joypad1 L"));
		keymaps.push_back(strpair_t("K00:SDLK_s",            "Joypad1 R"));
    ...
    name_sdlkeysym["SDLK_COMMA"] = SDLK_COMMA;
    name_sdlkeysym["SDLK_l"] = SDLK_l;
    name_sdlkeysym["SDLK_SEMICOLON"] = SDLK_SEMICOLON;
    name_sdlkeysym["SDLK_PERIOD"] = SDLK_PERIOD;
    name_sdlkeysym["SDLK_SLASH"] = SDLK_SLASH;
#endif /* BeagleSNES */
    ...
    case SDL_KEYDOWN:
      ...
      break;
		...
		case SDL_KEYUP:
			...
			{
				quit_state = TRUE;
fprintf(stderr, "AWH: quit_state = TRUE\n");
			} 
